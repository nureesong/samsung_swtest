...
// 일련의 행동들을 한 바퀴 돌리고 나면, 연한 칸은 항상 비어있으므로 버퍼공간으로 생각할 수 있다.
// 빨간색 보드는 따로 두지 않았고 초록색, 파란색 보드를 각각 6x4 로 두고, 0~1행 버퍼 공간에 블록을 올린다고 생각했다.
// 파란색 보드를 90도 돌려서 초록색 보드와 똑같이 아래 방향만 생각했다.
// 배열을 포인터로 넘겨서 블록 쌓고 점수 계산하는 일련의 행동들을 하나의 함수로 구현했다.
/*************************************/
